...
export class TeachersController {
  ...
  @Get()
  async findAll() { return this.listTeachersService.execute(); }

  @Get(":id")
  async findById(@Param("id") id: string) { return this.returnTeacherService.executeById(id); }

  @Post()
  async create(@Body() body: TeacherDto) { return this.createTeacherService.execute(body); }

  @Put(":id")
  async update(@Param("id") id: string, @Body() body: TeacherDto) { return this.editTeacherService.execute(id, body); }

  @Delete(":id")
  async remove(@Param("id") id: string) { return this.removeTeacherService.execute(id); }
}